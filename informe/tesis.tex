...
%	\end{algorithm}
	...
	con los valores de los componentes y otra que lo hace con los logaritmos. Sin embargo, en este caso, los resultados
	obtenidos son prácticamente idénticos. El pseudocódigo -donde omitimos
	...
	de las variables y para aquella que lo hace con los logaritmos, respectivamente. En el apéndice \ref{subsec:ResultadosR1Fijo} incluimos
	la tabla con los resultados completos para la versión logarítmica.
	...
	\begin{table}[H]
		...
		\hline
		11000 & 33000 & 8200 & \expnumber{2.7}{-8} & \expnumber{3.3}{-9} & 0\% & 2.499\% & 1.145\% & 0.7508 \\
		3600 & 11000 & 2700 & \expnumber{8.2}{-8} & \expnumber{1}{-8} & 1.852\% & 1.985\% & 0.561\% & 0.7540 \\
		36000 & 110000 & 27000 & \expnumber{8.2}{-9} & \expnumber{1}{-9} & 1.852\% & 1.985\% & 0.561\% & 0.7540 \\
		12000 & 36000 & 8200 & \expnumber{2.7}{-8} & \expnumber{3.3}{-9} & 0\% & 1.865\% & 1.036\% & 0.7616 \\
		3300 & 10000 & 2200 & \expnumber{1}{-7} & \expnumber{1.2}{-8} & 1.010\% & 2.047\% & 1.510\% & 0.7668 \\
		\hline
		\end{array}
		$$
	...
	\begin{table}[H]
		...
		R_1 & R_2 & R_3 & C_4 & C_5 & Err_G & Err_\omega & Err_Q & Sens \\
		\hline
		11000 & 32994.83 & 8249.68 & \expnumber{2.73}{-8} & \expnumber{3.41}{-9} & 0.016\% & 0\% & 0\% & 0.75 \\
		3600 & 10798.31 & 2699.89 & \expnumber{8.34}{-8} & \expnumber{1.04}{-8} & 0.016\% & 0.001\% & 0.001\% & 0.75 \\
		36000 & 107983.07 & 26998.94 & \expnumber{8.34}{-9} & \expnumber{1.04}{-9} & 0.016\% & 0\% & 0\% & 0.75 \\
		12000 & 35994.26 & 8992.64 & \expnumber{2.5}{-8} & \expnumber{3.13}{-9} & 0.016\% & 0\% & 0\% & 0.75 \\
		3300 & 9898.45 & 2474.90 & \expnumber{9.09}{-8} & \expnumber{1.14}{-8} & 0.016\% & 0\% & 0\% & 0.75 \\
		\hline
		\end{array}
		$$
		\caption{Resultados obtenidos fijando $R_1$ y dejando el resto de las variables libres. Versión común}
		\label{cuadroSolsCom}
	\end{table}
	...
	código \textit{Python} puede verse en el apéndice \ref{subsec:pythonacor}.
	...
	\section{\textbf{Tablas de Resultados}}
		...
		\begin{table}[H]
			...
			aquellos para los cuales no se encontró solución. Se omiten los de la versión común ya que son prácticamente iguales.}
